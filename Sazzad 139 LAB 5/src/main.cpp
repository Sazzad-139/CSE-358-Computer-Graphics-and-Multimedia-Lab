...
"void main()\n"
"{\n"
"   FragColor = vec4(1.0, colorValue, colorValue, 1.0);\n"
"}\0";
...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Scaling Rotating Rectangle", NULL, NULL);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        float scaleFactor = sin(timeValue) * 0.5f + 1.0f;
        ...
        unsigned int colorLoc = glGetUniformLocation(shaderProgram, "colorValue");
